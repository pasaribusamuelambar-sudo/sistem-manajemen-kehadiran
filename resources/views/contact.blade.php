    ...
    <nav class="fixed w-full z-50 bg-white/70 backdrop-blur-lg border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="hidden md:flex space-x-10 font-semibold text-sm text-slate-600 uppercase tracking-widest">
                ...
                <a href="{{ url('contact') }}" class="text-blue-600">Kontak Kami</a>
            </div>
        </div>
    </nav>
            ...
            <div class="grid md:grid-cols-3 gap-10">
                ...
                <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-xl shadow-slate-100/50 flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-300">
                    <div class="w-32 h-32 bg-slate-100 rounded-full mb-6 overflow-hidden border-4 border-white shadow-md">
                        <img src="https://ui-avatars.com/api/?name=Member+One&background=0D8ABC&color=fff" alt="Foto Profil" class="w-full h-full object-cover">
                    </div>
                    <h3 class="text-xl font-extrabold text-slate-800 mb-1">SAMUEL AMBAR PASARIBU</h3>
                    <p class="text-blue-600 text-[10px] font-black uppercase tracking-widest mb-4 italic">DIREKTUR KEUNGAN</p>
                ...
                <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-xl shadow-slate-100/50 flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-300">
                    <div class="w-32 h-32 bg-slate-100 rounded-full mb-6 overflow-hidden border-4 border-white shadow-md">
                        <img src="https://ui-avatars.com/api/?name=Member+Two&background=6366f1&color=fff" alt="Foto Profil" class="w-full h-full object-cover">
                    </div>
                    ...
                    <div class="flex space-x-3 w-full">
                        <a href="https://wa.me/628123456789" class="flex-1 bg-green-500 text-white p-3 rounded-xl hover:bg-green-600 transition text-lg"><i class="bi bi-whatsapp"></i></a>
                        ...
                        <a href="https://www.instagram.com/adityarizki.kurniawan" class="flex-1 bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white p-3 rounded-xl hover:opacity-90 transition text-lg"><i class="bi bi-instagram"></i></a>
                    </div>
                </div>

                <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-xl shadow-slate-100/50 flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-300">
                    <div class="w-32 h-32 bg-slate-100 rounded-full mb-6 overflow-hidden border-4 border-white shadow-md">
                        <img src="https://ui-avatars.com/api/?name=Member+Three&background=1e293b&color=fff" alt="Foto Profil" class="w-full h-full object-cover">
                    </div>
                    ...
                    <div class="flex space-x-3 w-full">
                        ...
                        <a href="https://www.instagram.com/muhammad.hoirul.farhan" class="flex-1 bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white p-3 rounded-xl hover:opacity-90 transition text-lg"><i class="bi bi-instagram"></i></a>
                    </div>
                </div>
